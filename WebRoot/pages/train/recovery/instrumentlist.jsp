...
<script type="text/javascript">
 ...
 function mentDel(mnumber){
		 var but = window.confirm("确定删除该记录吗？");
		 if(but){
		       $.ajax({
			   type: "POST",
			   url: basePath + "/instrumentdeletement.do", 
...
function mentEdit(mnumber){
   window.location.href=basePath+"/instrumentmentmodify.do?mnumber="+mnumber;
}

function mentView(mnumber){
   window.location.href=basePath+"/instrumentmentview.do?mnumber="+mnumber;
}
...
<body>
<div class="topLanBar"><b>当前位置：</b>护理管理> 康复服务> 器械康复记录表</div>
<table width="100%">
  <tr>
...
<form method="post" name="actform" action="instrumentlist.do">
  <table width="100%" border="0" cellspacing="0" cellpadding="2">
    ...
    <tr>
      ...
      <td><input name="mname" id="mname" value="" type="text" size="20">
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableList">
     <tr>
       <td><button onClick="forward('instrumentadd.do')" id="001">新建器械康复记录</button></td>
       <td></td>
       <td></td>
       <td></td>
      <!-- <td align="right"><button onClick="forward('instrumenthistory.do')" id="001">历史记录</button></td>-->
    </tr>
    <tr>
      <th nowrap>日期</th>
      <th nowrap>姓名</th>
    ...
    <tr>
	      ...
	      <td align="center" nowrap bgcolor="#E4E4E4">${ment.mbelongpro} </td>
	      <td align="center" nowrap bgcolor="#E4E4E4"><a href="javascript:mentView('${ment.mnumber}');">明细</a>&nbsp;&nbsp;<a href="javascript:mentEdit('${ment.mnumber}');">编辑</a>&nbsp;&nbsp;<a href="javascript:mentDel('${ment.mnumber}');">删除</a>&nbsp;&nbsp;</td>
    </tr>
    </c:forEach>
    <wt:pages />
    </c:otherwise>
