...
public class Member implements java.io.Serializable
{
    ...
    //被护理评估次数 0:未进行 1:1次 ...
    private String isCareEva;
    
    //被康复评估次数 0:未进行 1：1次 ...
    private String isRecoverEva;

    //被健康评估次数 0:未进行 1：1次 ...
    private String isHealthEva;
    
    //被健康心理评估次数 0:未进行，1：1次
    private String isHealthPsyEva;
    // Constructors
    /** default constructor */
    public Member()
    {
    ...
    /** minimal constructor */
    public Member(String meminfoid, String memname, String memid,
	...
	public String getIsCareEva() {
		return isCareEva;
	}

	public void setIsCareEva(String isCareEva) {
		this.isCareEva = isCareEva;
	}

	public String getIsRecoverEva() {
		return isRecoverEva;
	}

	public void setIsRecoverEva(String isRecoverEva) {
		this.isRecoverEva = isRecoverEva;
	}

	public String getIsHealthEva() {
		return isHealthEva;
	}

	public void setIsHealthEva(String isHealthEva) {
		this.isHealthEva = isHealthEva;
	}

	public String getIsHealthPsyEva() {
		return isHealthPsyEva;
	}

	public void setIsHealthPsyEva(String isHealthPsyEva) {
		this.isHealthPsyEva = isHealthPsyEva;
	}
