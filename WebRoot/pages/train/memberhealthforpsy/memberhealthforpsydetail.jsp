...
<table width="100%"  style="margin:auto"  class="tab1" id="tab1" border="0">
  <tr>
    <td>会员姓名:<input   type="text" name="memname" id="memname" onclick="chooseElders()" value="${health.memname}" readonly/><span style='color:red;'>&nbsp;*</span></td>
    <td>档案编号:<input   type="text" name="healthnumber" id="healthnumber" value="${health.healthnumber}" readonly/><span style='color:red;'>&nbsp;*</span></td>
    <td>申请原因:<select  id="applyreason" name="applyreason" readonly>
    ...
    <td>评估日期:<input type="text" class="Wdate" name="assesdate" value="${health.assesdate}" id="assesdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" readonly/><span style='color:red;'>&nbsp;*</span></td>
    <td>所属项目:<input type="text"  id="belongproname" name="belongproname" value="${health.belongproname}" onclick="choosePro()" readonly><span style='color:red;'>&nbsp;*</span></td> 
  </tr>
</table>
</div>
<p>&nbsp;</p>
<div style="text-align:center"><table style="margin:auto" width="95%" border="1" class="tabcss">
  ...
  <tr>
    ...
    <td height="35" colspan="11"><select readonly name="a1" id="a1" style="width:50px">
  ...
  <tr>
    <td height="37" colspan="6"><input readonly  type="checkbox" class="checkBox1"  name="a2" id="a2" />
      a.短期记忆力 -回想5分钟前发生的事</td>
    <td colspan="5"><input readonly  type="checkbox" class="checkBox1"  name="a3" id="a3" />
      b.程序记忆 -不用提醒能够想起所有或大部分测试项目环节中的顺序</td>
  </tr>
  <tr>
    <td rowspan="2"><div align="center">日常判断能力</div></td>
    <td height="30" colspan="5"><input readonly  type="checkbox" class="checkBox1"  name="a4" id="a4"/>
      a.服务老人如何决定一天安排(例如，什么时候起床或吃早饭，穿哪件衣服，参与什么活动)</td>
    <td colspan="6">b.比过去90天糟糕：
      <select readonly name="a5" id="a5" style="width:50px">
...
0.否
  ...
  <tr>
    <td height="31" colspan="11">      <select readonly name="a6" id="a6" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11">是否有必要进行？
      <select readonly name="a7" id="a7" style="width:50px" onchange="Bian('a8','',this.options.selectedIndex)">
	      <option value="0" ${health.a7 == 0 ? "selected" : ""}>0</option>
	      <option value="1" ${health.a7 == 1 ? "selected" : ""}>1</option>
      </select>
0.否 
1.是 分数：
    <input readonly  type=text id="a8" name="a8" size="5" />
    分</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="11"><select readonly name="a9" id="a9" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11"><select readonly name="a10" id="a10" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11">比过去90天糟糕：
      <select readonly name="a11" id="a11" style="width:50px">
...
1.是</td>
  ...
  <tr>
    ...
    <td colspan="11">(正常光线及佩戴眼镜可见）
      <select readonly name="a12" id="a12" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11">看到光圈、眼前有暗区或有闪光
      <select readonly name="a13" id="a13" style="width:50px">
  ...
  <tr>
    <td><div align="center">沟通能力</div></td>
    <td colspan="11">比过去90天糟糕：
      <select readonly name="a14" id="a14" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11">（选择以下编号）
      <select readonly name="a15" id="a15" style="width:50px">
  ...
  <tr>
    <td colspan="11"><input readonly  type="checkbox" class="checkBox1"  name="a16" id="a16" />
      a.感到悲伤或抑郁，认为或者没有什么值留恋，任何事情都不在乎，认为自己没用还不如死了
     <input readonly  type="checkbox" class="checkBox1"  name="a17" id="a17" />
      b.持续对自己或对他人发怒，例如在接受护理的时候容易烦躁、发怒
     <input readonly  type="checkbox" class="checkBox1"  name="a18" id="a18" />
      c.表现出不切实际的担忧，例如担心被排期、被孤立</td>
  </tr>
  <tr>
    <td colspan="11"><input readonly  type="checkbox" class="checkBox1"  name="a19" id="a19" />
      d.反复抱怨健康，例如经常看医生、过度注意自己的身体功能
     <input readonly  type="checkbox" class="checkBox1"  name="a20" id="a20" />
      e.反复抱怨担忧与焦虑，例如过度紧张日程安排、三餐安排、清洁、服装以及与他人关系
     <input readonly  type="checkbox" class="checkBox1"  name="a21" id="a21" />
      f.脸上表现出担忧、痛苦、难过，例如皱眉</td>
  </tr>
  <tr>
    <td colspan="11"><input readonly  type="checkbox" class="checkBox1"  name="a22" id="a22" />
      g.经常哭泣
     <input readonly  type="checkbox" class="checkBox1"  name="a23" id="a23" />
    h.丧失兴趣爱好，例如放弃长久以来的兴趣爱好或不与家人朋友交往
   <input readonly  type="checkbox" class="checkBox1"  name="a24" id="a24" />
    i.减少社交活动</td>
  </tr>
  <tr>
    <td><div align="center">心情变差</div></td>
    <td colspan="11">比过去90天糟糕：
      <select readonly name="a25" id="a25" style="width:50px">
  ...
  <tr>
    ...
    <td height="40" colspan="11"><select readonly name="a26" id="a26" style="width:50px">
  ...
  <tr>
    <td colspan="5"><input readonly  type="checkbox" class="checkBox1"  name="a27" id="a27" />
    a.没有目的的闲逛</td>
    <td colspan="4"><input readonly  type="checkbox" class="checkBox1"  name="a28" id="a28" />
    b.滥用言语，威吓、尖叫、诅咒他人</td>
    <td colspan="2"><input readonly  type="checkbox" class="checkBox1"  name="a29" id="a29" />
      c.伤害行为，例如打、掴、性侵<br />
    犯他人</td>
  </tr>
  <tr>
    <td colspan="5"><input readonly  type="checkbox" class="checkBox1"  name="a30" id="a30" />
    d.社交不当行为，例如重复打断他人声音、噪音、尖叫、自虐行为、公共场所脱衣、乱扔/糟蹋食物/排泄物、乱翻物品等造成干扰行为</td>
    <td colspan="6"><input readonly  type="checkbox" class="checkBox1"  name="a31" id="a31" />
    e.拒绝护理，例如拒绝治疗、服药、生活辅助、吃饭、或更换位置</td>
  </tr>
  <tr>
    <td><div align="center">行为变化</div></td>
    <td colspan="11">比过去90天糟糕 
      <select readonly name="a32" id="a32" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11">是否进行进一步心理评估：
      <select readonly  name="a33" id="a33" style="width:50px">
...
1.是</td>
  ...
  <tr>
    ...
    <td colspan="7">a.容易与他人相处
      <select readonly  name="a34" id="a34" style="width:50px">
    ...
    <td colspan="4">b.与家人/朋友有公开矛盾或冲突 
      <select readonly name="a35" id="a35" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11">比过去90天下降：
      <select readonly name="a36" id="a36" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="7">a.白天晚上或一整天一个人独处 
      <select readonly name="a37" id="a37" style="width:50px">
    ...
    <td colspan="4">b.表示感到孤独 
      <select readonly name="a38" id="a38" style="width:50px">
  ...
  <tr>
    <td><div align="center">进一步评估</div></td>
    <td colspan="11">是否进行进一步心理评估：      
      <select readonly name="a39" id="a39" style="width:50px">
  ...
  <tr>
    <td rowspan="4"><div align="center">IADL评定分数(* 7天内工具性日常生活能力)
      <input readonly  type="text" size="5" name="a40" id="40"/>
    </div></td>
    <td colspan="7">a.使用电话能力
      <select readonly name="a41" id="a41" style="width:50px">
...
0.无法拨打电话
    ...
    <td colspan="4">b.购物
      <select readonly  name="a42" id="a42" style="width:50px">
...
0.可以进行小额采购；需要买东西时有<br />
  ...
  <tr>
    <td colspan="7">c.三餐准备 
      <select readonly name="a43" id="a43" style="width:50px">
...
0.能够加热或准备速食食品，但没有充<br />
    ...
    1.独立计划、烹饪三餐。</td>
    <td colspan="4">d.居家卫生 
      <select readonly name="a44" id="a44" style="width:50px">
...
0.无法进行任何居家卫生清洁 
  ...
  <tr>
    <td colspan="7">e. 衣物清洗
      <select readonly name="a45" id="a45" style="width:50px">
    ...
    <td colspan="4">f. 交通方式
      <select readonly name="a46" id="a46" style="width:50px">
  ...
  <tr>
    <td colspan="7">g. 服药
      <select readonly  name="a47" id="a47" style="width:50px">
    ...
    <td colspan="4">h. 理财
      <select readonly name="a48" id="a48" style="width:50px">
  ...
  <tr>
    <td rowspan="5"><div align="center">ADL评定分数(* 5天内日常生活自理能力)
      <input readonly  type="text" size="5" name="a49" id="a49"/>
    </div></td>
    <td colspan="7">a. 进食
      <select readonly name="a50" id="a50" style="width:50px">
    ...
    <td colspan="4">b. 洗浴
      <select readonly name="a51" id="a51" style="width:50px">
  ...
  <tr>
    <td colspan="7">e. 大便
      <select readonly name="a54" id="a54" style="width:50px">
    ...
    <td colspan="4">f. 小便 
      <select readonly  name="a55" id="a55" style="width:50px">
  ...
  <tr>
    <td colspan="7">g. 如厕 
      <select readonly name="a56" id="a56" style="width:50px">
    ...
    <td colspan="4">h. 转移（床与椅子之间）
      <select readonly name="a57" id="a57" style="width:50px">
  ...
  <tr>
    <td colspan="7">i. 平地行走
      <select readonly name="a58" id="a58" style="width:50px">
      ...
      如拐杖）步行大于45米。</td>
    <td colspan="4">j. 楼梯
      <select readonly name="a59" id="a59" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11">ADL状态比过去90天糟糕：    
      <select readonly name="a60" id="a60" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11"><select readonly name="a61" id="a61" style="width:50px">
  ...
  <tr>
    <td colspan="11"><input readonly  type="checkbox" class="checkBox1"  name="a62" id="a62" onclick="enableCheck(64)"/>
    室内  <input readonly  type="checkbox" class="checkBox1"  name="a63" id="a63" onclick="enableCheck(64)"/>
    室外 
    <input readonly  type="checkbox" class="checkBox1"  name="a64" id="a64" onclick="disAb(62,63);"/>     没有任何活动</td>
  </tr>
  <tr>
    <td rowspan="2"><div align="center">忍耐</div></td>
    <td colspan="11">a.一般一周内（过去90天中，或自上次评估后）老人走出家门、大楼的频率 
      <select readonly name="a65" id="a65" style="width:50px">
  ...
  <tr>
    <td colspan="11">b.最近3天内的运动小时数（例如散步、锻炼）
      <select readonly name="a66" id="a66" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11"><input readonly  type="checkbox" class="checkBox1"  name="a274" id="a274" onclick="enableCheck(69)"/>
      老人相信他/她能够提升自理能力（ADL、IADL、mobility）。
     <input readonly  type="checkbox" class="checkBox1"  name="a67" id="a67" onclick="enableCheck(69)"/>
      护理、康复人员相信老人有提升自理能力（ADL、IADL、mobility）可能 。
    <input readonly  type="checkbox" class="checkBox1"  name="a68" id="a68" onclick="enableCheck(69)"/>
      现疾病、情况康复状况良好，预期健康状态能改善。
      <input readonly  type="checkbox" class="checkBox1"  name="a69" id="a69" onclick="disAb(67,68);"/>
      以上都不是。</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="11">a.7天内小便排便功能（插管或者特殊排便护理要求的老人）
      <select readonly name="a70" id="a70" style="width:50px">
  ...
  <tr>
    <td colspan="11">b.比过去90天糟糕：
      <select readonly name="a71" id="a71" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11"><div align="left">（最近7天内检查装置）
      <input readonly  type="checkbox" class="checkBox1"  name="a72" id="a72" onclick="enableCheck(74)"/>
      使用成人尿布或者防护垫  
      <input readonly  type="checkbox" class="checkBox1"  name="a73" id="a73" onclick="enableCheck(74)"/>
      使用导尿管 
      <input readonly  type="checkbox" class="checkBox1"  name="a74" id="a74" onclick="disAb(72,73);"/>
  ...
  <tr>
    ...
    <td colspan="11">（最近7天内排便情况）
      <select readonly name="a75" id="a75" style="width:50px">
  ...
  <tr>
    ...
    <td height="66" colspan="7">心脑血管疾病 
      <input readonly  type="checkbox" class="checkBox1"  name="a76" id="a76" onclick="enableCheck(104)"/>
    a.脑血管疾病（如中风）
    <input readonly  type="checkbox" class="checkBox1"  name="a77" id="a77" onclick="enableCheck(104)"/>
    b.心力衰竭 
    <input readonly  type="checkbox" class="checkBox1"  name="a78" id="a78" onclick="enableCheck(104)"/>
    c.冠心病（心肌梗塞、心绞痛）
    <input readonly  type="checkbox" class="checkBox1"  name="a79" id="a79" onclick="enableCheck(104)"/>
    d.高血压 
    <input readonly  type="checkbox" class="checkBox1"  name="a80" id="a80" onclick="enableCheck(104)"/>
    e.心律不齐 
   <input readonly  type="checkbox" class="checkBox1"  name="a81" id="a81" onclick="enableCheck(104)"/>
    f.外周动脉疾病</td>
    <td colspan="4">神经系统
    <input readonly  type="checkbox" class="checkBox1"  name="a82" id="a82" onclick="enableCheck(104)"/>
    g. 阿兹海默症 
   <input readonly  type="checkbox" class="checkBox1"  name="a83" id="a83" onclick="enableCheck(104)"/>
    h. 阿兹海默症以外的痴呆症 
   <input readonly  type="checkbox" class="checkBox1"  name="a84" id="a84" onclick="enableCheck(104)"/>
    i. 头部创伤 
   <input readonly  type="checkbox" class="checkBox1"  name="a85" id="a85" onclick="enableCheck(104)"/>
    j. 偏瘫
   <input readonly  type="checkbox" class="checkBox1"  name="a86" id="a86" onclick="enableCheck(104)"/>
    k. 多发性硬化症（癫痫）
    <input readonly  type="checkbox" class="checkBox1"  name="a87" id="a87" onclick="enableCheck(104)"/>
    l. 帕金森氏症</td>
  </tr>
  <tr>
    <td height="67" colspan="7">骨骼肌系统
   <input readonly  type="checkbox" class="checkBox1"  name="a88" id="a88" onclick="enableCheck(104)"/>
    m. 关节炎
   <input readonly  type="checkbox" class="checkBox1"  name="a89" id="a89" onclick="enableCheck(104)"/>
    n. 髋部骨折
   <input readonly  type="checkbox" class="checkBox1"  name="a90" id="a90" onclick="enableCheck(104)"/>
    o. 其他骨折（如腕、脊椎）
    <input readonly  type="checkbox" class="checkBox1"  name="a91" id="a91" onclick="enableCheck(104)"/>
    p. 骨质疏松症</td>
    <td colspan="4">感觉
     <input readonly  type="checkbox" class="checkBox1"  name="a92" id="a92" onclick="enableCheck(104)"/>
    q. 白内障 
    <input readonly  type="checkbox" class="checkBox1"  name="a93" id="a93" onclick="enableCheck(104)"/>
    r. 青光眼</td>
  </tr>
  <tr>
    <td colspan="4">精神疾病
    <input readonly  type="checkbox" class="checkBox1"  name="a94" id="a94" onclick="enableCheck(104)"/>
    s. 任何精神疾病诊断</td>
    <td colspan="7">感染     <input readonly  type="checkbox" class="checkBox1"  name="a95" id="a95" onclick="enableCheck(104)"/>
    t. HIV（艾滋）
   <input readonly  type="checkbox" class="checkBox1"  name="a96" id="a96" onclick="enableCheck(104)"/>
    u. 肺炎
   <input readonly  type="checkbox" class="checkBox1"  name="a97" id="a97" onclick="enableCheck(104)"/>
    v. 肺结核 
   <input readonly  type="checkbox" class="checkBox1"  name="a98" id="a98" onclick="enableCheck(104)"/>
    w. 尿路感染（30天内）</td>
  </tr>
  <tr>
    <td height="30" colspan="11">其他疾病 
   <input readonly  type="checkbox" class="checkBox1"  name="a99" id="a99" onclick="enableCheck(104)"/>
    x.癌症（近5年内），不包括皮肤癌 
    <input readonly  type="checkbox" class="checkBox1"  name="a100" id="a100" onclick="enableCheck(104)"/>
    y. 糖尿病 
   <input readonly  type="checkbox" class="checkBox1"  name="a101" id="a101" onclick="enableCheck(104)"/>
    z.肺气肿/慢性阻塞性肺病/哮喘结核 
   <input readonly  type="checkbox" class="checkBox1"  name="a102" id="a102" onclick="enableCheck(104)"/>
    aa. 肾功能衰竭 
   <input readonly  type="checkbox" class="checkBox1"  name="a103" id="a103" onclick="enableCheck(104)"/>
    ab. 甲状腺疾病 </td>
  </tr>
  <tr>
    <td height="70" colspan="2"><input readonly  type="checkbox" class="checkBox1"  name="a104" id="a104" onclick="disAb(76,103);"/>
    ac. 以上都不是</td>
    <td colspan="9">其他疾病描述
    <textarea readonly name="a105" id="a105" cols="80" rows="3"></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="6">血型：
      <select readonly name="a106" id="a106" style="width:50px">
    ...
    <td colspan="5">过敏史：      
      <select readonly name="a107" id="a107" style="width:50px">
  ...
  <tr>
    <td colspan="6">手术史：
      <select readonly name="a108" id="a108" style="width:50px" onchange="Bian('a109','a110',this.options.selectedIndex)">
      ...
      0.无
       1.有<br>
年份
<input readonly  type="text" class="Wdate" name="a109" id="a109" onClick="WdatePicker({dateFmt:'yyyy',readOnly:true})" /> 名称 <input readonly  type="text" size="20" name="a110" id="a110" /></td>
    <td colspan="5">身高（cm）
    <input readonly  type="text" size="7" name="a111" id="a111"/>
     体重（kg）
    <input readonly  type="text" size="7" name="a112" id="a112"/>    
     腰围
    <input readonly  type="text" size="7" name="a113" id="a113" /></td>
  </tr>
  <tr>
    <td colspan="5">空腹血糖：
      <select readonly name="a114" id="a114" style="width:50px" onchange="Bian('a115','',this.options.selectedIndex)">
         <option value="0" ${health.a114 == 0 ? "selected" : ""}>0</option>
	     <option value="1" ${health.a114 == 1 ? "selected" : ""}>1</option>
      </select>
        0.未测
        1.已测
      <input readonly  type="text" size="7" name="a115" id="a115" />
     （mmol/L）</td>
    <td colspan="3">胸透检查：      
      <select readonly name="a116" id="a116" style="width:50px">
          <option value="0" ${health.a116 == 0 ? "selected" : ""}>0</option>
	      <option value="1" ${health.a116 == 1 ? "selected" : ""}>1</option>
    </select>0.无
       1.有</td>
    <td colspan="3">肝功能检查：      
      <select readonly name="a275" id="a275" style="width:50px">
  ...
  <tr>
    ...
    <input readonly  type="checkbox" class="checkBox1"  name="a117" id="a117" onclick="disAb(118,122)"/>无 
    <input readonly  type="checkbox" class="checkBox1"  name="a118" id="a118" onclick="enableCheck(117)"/>
    腹泻
    <input readonly  type="checkbox" class="checkBox1"  name="a119" id="a119" onclick="enableCheck(117)"/>
    排尿不畅,或晚间起夜3次以上
   <input readonly  type="checkbox" class="checkBox1"  name="a120" id="a120" onclick="enableCheck(117)"/>
    发烧
   <input readonly  type="checkbox" class="checkBox1"  name="a121" id="a121" onclick="enableCheck(117)"/>
    食欲下降
    <input readonly  type="checkbox" class="checkBox1"  name="a122" id="a122" onclick="enableCheck(117)"/>
    呕吐</td>
  </tr>
  <tr>
    <td><div align="center">问题症状近3天内出现的问题</td>
    <td colspan="11"><p>生理健康
      <input readonly  type="checkbox" class="checkBox1"  name="a123" id="a123" onclick="disAb(124,131)"/>
      无
      <input readonly  type="checkbox" class="checkBox1"  name="a124" id="a124" onclick="enableCheck(123)"/>
      平躺和放松时胸口有压力/疼痛
      <input readonly  type="checkbox" class="checkBox1"  name="a125" id="a125" onclick="enableCheck(123)"/>
      3天内未排便
     <input readonly  type="checkbox" class="checkBox1"  name="a126" id="a126" onclick="enableCheck(123)"/>
      晕眩
      <input readonly  type="checkbox" class="checkBox1"  name="a127" id="a127" onclick="enableCheck(123)"/>
      食欲下降
      <input readonly  type="checkbox" class="checkBox1"  name="a128" id="a128" onclick="enableCheck(123)"/>
      水肿
      <input readonly  type="checkbox" class="checkBox1"  name="a129" id="a129" onclick="enableCheck(123)"/>
      呼吸急促 </p>
      <p>精神健康
  <input readonly  type="checkbox" class="checkBox1"  name="a130" id="a130" onclick="enableCheck(123)"/>
        幻觉 
       <input readonly  type="checkbox" class="checkBox1"  name="a131" id="a131" onclick="enableCheck(123)"/>
    错觉</p></td>
  </tr>
  <tr>
    <td rowspan="5"><div align="center">疼痛</div></td>
    <td colspan="11">申请人抱怨疼痛频率
      <select readonly name="a132" id="a132" style="width:50px">
...
0.没有疼痛 1.几天一次 2.每天一次  3.每天多次</td>
  ...
  <tr>
    <td colspan="11">疼痛强度 
      <select readonly name="a133" id="a133" style="width:50px">
  ...
  <tr>
    <td colspan="11">申请人认为疼痛影响日常生活      
      <select readonly name="a134" id="a134" style="width:50px">
  ...
  <tr>
    <td colspan="11">疼痛患处      
      <select readonly name="a135" id="a135" style="width:50px">
  ...
  <tr>
    <td colspan="11">用药能够控制疼痛 
      <select readonly name="a136" id="a136" style="width:50px">
  ...
  <tr>
    ...
    <input readonly  type="text" size="7" name="a137" id="a137"/>
    次</td>
  </tr>
  <tr>
    <td><div align="center">跌倒危险性</div></td>
    <td colspan="6"> <select readonly name="a138" id="a138" style="width:50px">
            <option value="0" ${health.a138 == 0 ? "selected" : ""}>0</option>
	        <option value="1" ${health.a138 == 1 ? "selected" : ""}>1</option>
      </select> 
0.没有危险
1.有危险</td>
    <td colspan="5"><input readonly  type="checkbox" class="checkBox1"  name="a139" id="a139" />
    走步不稳 
    <input readonly  type="checkbox" class="checkBox1"  name="a140" id="a140" />
    申请人因害怕摔倒不愿意外出</td>
  </tr>
  <tr>
    <td><div align="center">生活方式</div></td>
    <td colspan="11">是否吸烟或者喝酒
     <input readonly  type="checkbox" class="checkBox1"  name="a141" id="a141" onclick="disAb(142,144)"/>
没有
<input readonly  type="checkbox" class="checkBox1"  name="a142" id="a142" onclick="enableCheck(141)"/>
90天内（或上次评估后），申请人感到或被人告知要少喝酒，或者他人为老人的饮酒习惯感到担心.
<input readonly  type="checkbox" class="checkBox1"  name="a143" id="a143" onclick="enableCheck(141)"/>
90天内（或上次评估后），申请人每天一早就开始喝酒或者因为喝酒造成问题
<input readonly  type="checkbox" class="checkBox1"  name="a144" id="a144" onclick="enableCheck(141)"/>
每天需要吸烟.</td>
  </tr>
  <tr>
    <td><div align="center">健康状态指向</div></td>
    <td colspan="11"><input readonly  type="checkbox" class="checkBox1"  name="a145" id="a145" onclick="enableCheck(150)"/>
    申请人感到他/她健康很糟糕
     <input readonly  type="checkbox" class="checkBox1"  name="a146" id="a146" onclick="enableCheck(150)"/>
      申请人的疾病或生活条件使得认知功能、脾气或者行为不稳定
<input readonly  type="checkbox" class="checkBox1"  name="a147" id="a147" onclick="enableCheck(150)"/>
经历突发性严重疾病或慢性疾病
<input readonly  type="checkbox" class="checkBox1"  name="a148" id="a148" onclick="enableCheck(150)"/>
近30天内（或上次评估后）由于突发状况治疗变化
<input readonly  type="checkbox" class="checkBox1"  name="a149" id="a149" onclick="enableCheck(150)"/>
    诊断活不过6个月 -例如医生告知申请者或其家人申请人在病症晚期
    <input readonly  type="checkbox" class="checkBox1"  name="a150" id="a150" onclick="disAb(145,149)"/>
    以上都不是</td>
  </tr>
  <tr>
    <td><div align="center">其他状态指向</div></td>
    <td colspan="11"><input readonly  type="checkbox" class="checkBox1"  name="a151" id="a151" onclick="enableCheck(157)"/>
    害怕家人或者护理者
     <input readonly  type="checkbox" class="checkBox1"  name="a152" id="a152" onclick="enableCheck(157)"/>
      个人卫生情况很糟糕
<input readonly  type="checkbox" class="checkBox1"  name="a153" id="a153" onclick="enableCheck(157)"/>
无法解释的创伤、骨折或烧伤
<input readonly  type="checkbox" class="checkBox1"  name="a154" id="a154" onclick="enableCheck(157)"/>
    被忽视、侵害或虐待
    <input readonly  type="checkbox" class="checkBox1"  name="a155" id="a155" onclick="enableCheck(157)"/>
    <input readonly  type="hidden" class="checkBox1"  name="a156" id="a156" onclick="enableCheck(157)"/>
    肢体受缚（如四肢被绑、坐在椅子上时被绑）
<input readonly  type="checkbox" class="checkBox1"  name="a157" id="a157" onclick="disAb(151,156)"/>
以上都不是</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="11"><input readonly  type="checkbox" class="checkBox1"  name="a158" id="a158"/>
    30天内不刻意流失5%体重（180天内体重下降10%）
   <input readonly  type="checkbox" class="checkBox1"  name="a159" id="a159"/>
    严重营养不良（极瘦弱）
    <input readonly  type="checkbox" class="checkBox1"  name="a160" id="a160"/>
    病态 超重</td>
  </tr>
  <tr>
    <td><div align="center">消耗</div></td>
    <td colspan="11"><input readonly  type="checkbox" class="checkBox1"  name="a161" id="a161"/>
    近2-3天内每天吃1顿或很少
    <input readonly  type="checkbox" class="checkBox1"  name="a162" id="a162"/>
    近3天内申请人平时吃的食物或饮水明显减少
   <input readonly  type="checkbox" class="checkBox1"  name="a163" id="a163"/>
    水份不足近3天几乎很少补充水份
  <input readonly  type="checkbox" class="checkBox1"  name="a164" id="a164"/>
    需用食管进食</td>
  </tr>
  <tr>
    <td><div align="center">吞咽</div></td>
    <td colspan="11"><input readonly  type="checkbox" class="checkBox1"  name="a165" id="a165"/>
      正常
     <input readonly  type="checkbox" class="checkBox1"  name="a166" id="a166"/>
      需要对大块需要咀嚼的食物进行加工（例如肉块切碎）
     <input readonly  type="checkbox" class="checkBox1"  name="a167" id="a167"/>
      需要对大块需要咀嚼的食物以及浓稠液体加工
     <input readonly  type="checkbox" class="checkBox1"  name="a168" id="a168"/>
      需要口腔与食管喂食</td>
  </tr>
  <tr>
    <td><div align="center">过去治愈的溃疡</div></td>
    <td colspan="11">申请人过去在身体任何部位出现过的溃疡
      <select readonly name="a169" id="a169" style="width:50px">
...
1.有</td>
  ...
  <tr>
    ...
    <td colspan="11">过去护理的7天内
     <input readonly  type="checkbox" class="checkBox1"  name="a170" id="a170" onclick="enableCheck(174)"/>
    抗生素（全身或局部）
   <input readonly  type="checkbox" class="checkBox1"  name="a171" id="a171" onclick="enableCheck(174)"/>
    外敷
   <input readonly  type="checkbox" class="checkBox1"  name="a172" id="a172" onclick="enableCheck(174)"/>
    术后伤口护理
   <input readonly  type="checkbox" class="checkBox1"  name="a173" id="a173"  onclick="enableCheck(174)"/>
    其他疮伤护理（如压力衣、食疗，）
   <input readonly  type="checkbox" class="checkBox1"  name="a174" id="a174" onclick="disAb(170,173)"/>
    以上都不是</td>
  </tr>
  <tr>
  ...
  <tr>
     ...
     <td colspan="11">
       <select name="a276" id="a276" style="width:50px" readonly>
  ...
  <tr>
    ...
    <td colspan="11">任何皮肤问题或皮肤状态变化
      <select readonly name="a179" id="a179" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="8">身体任何地方出现溃疡
      <select readonly name="a180" id="a180" style="width:50px">
    ...
    <td colspan="3"><input readonly  type="checkbox" class="checkBox1"  name="a181" id="a181"/>
      压疮
     <input readonly  type="checkbox" class="checkBox1"  name="a182" id="a182"/>
      郁血性溃疡</td>
  </tr>
  <tr>
    <td><div align="center">其他需要治疗的皮肤疾病</div></td>
    <td colspan="11"><input readonly  type="checkbox" class="checkBox1"  name="a183" id="a183" onclick="enableCheck(186)"/>
    烧伤（2级或3级）
     <input readonly  type="checkbox" class="checkBox1"  name="a184" id="a184" onclick="enableCheck(186)"/>
    破裂溃疡、红疹或伤口
    <input readonly  type="checkbox" class="checkBox1"  name="a273" id="a273" onclick="enableCheck(186)"/>
    皮肤出脓
    <input readonly  type="checkbox" class="checkBox1"  name="a185" id="a185" onclick="enableCheck(186)"/>
    术后伤口
    <input readonly  type="checkbox" class="checkBox1"  name="a186" id="a186"  onclick="disAb(183,185)"/>
    以上都不是</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="11">是否需要提供居家安全评估（上门服务申请者提供）
      <select readonly name="a175" id="a175" style="width:50px" onchange="Bian('a176','',this.options.selectedIndex)">
            <option value="0" ${health.a175 == 0 ? "selected" : ""}>0</option>
	        <option value="1" ${health.a175 == 1 ? "selected" : ""}>1</option> 
      </select>
      0.需要
      1.不需要 居家安全评估分数
      <input readonly  type="text" size="7" name="a176" id="a176" />
      分</td>
  </tr>
  <tr>
    <td><div align="center">居住布局</div></td>
    <td colspan="5">与90天前相比（或上次评估后）申请者现在与他人一同居住（例如，搬去他人家中或别人搬入自己家中）
      <select readonly name="a177" id="a177" style="width:50px">
    ...
    <p>
      <select readonly name="a178" id="a178" style="width:50px">
  ...
  <tr>
    ...
    <input readonly  type="text" size="7" name="a187" id="a187"/></td>
  </tr>
  <tr>
    <td><div align="center">影响精神的药物</div></td>
    <td colspan="11">7天内服务影响精神的药物
      <select readonly name="a188" id="a188" style="width:50px" onchange="BianCheck(189,192,this.options.selectedIndex)">
            <option value="0" ${health.a188 == 0 ? "selected" : ""}>0</option>
	        <option value="1" ${health.a188 == 1 ? "selected" : ""}>1</option> 
      </select>
      0.无 1.有 
     <input readonly  type="checkbox" class="checkBox1"  name="a189" id="a189" onclick="enableselect(188)"/>
      抗精神病药物
<input readonly  type="checkbox" class="checkBox1"  name="a190" id="a190" onclick="enableselect(188)"/>
镇痛药物
<input readonly  type="checkbox" class="checkBox1"  name="a191" id="a191" onclick="enableselect(188)"/>
抗抑郁药物
<input readonly  type="checkbox" class="checkBox1"  name="a192" id="a192" onclick="enableselect(188)"/>
安眠药物</td>
  </tr>
  <tr>
    <td><div align="center">用药咨询</div></td>
    <td colspan="11">180天内是否有主治医师对用药进行了解
      <select readonly name="a193" id="a193" style="width:50px">
...
0.向至少1位医师咨询 1.所有药物未得到任何医生咨询</td>
  ...
  <tr>
    ...
    <td colspan="11">30天内，坚持根据医嘱用药情况：
      <select readonly name="a194" id="a194" style="width:50px">
  ...
  <tr>
    <td colspan="13"><div align="left">家庭健康辅助&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input readonly  type="text" size="7" name="a200" id="a200"/>
    日
    <input readonly  type="text" size="7" name="a201" id="a201"/>
小时
<input readonly  type="text" size="7" name="a202" id="a202"/>
分钟</div>      <div align="left"></div>      <div align="left"></div>    <div align="left"></div></td>
  </tr>
  <tr>
    <td colspan="13"><div align="left">家庭医生\护士上门&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input readonly  type="text" size="7" name="a203" id="a203"/>
        日      
        <input readonly  type="text" size="7" name="a204" id="a204"/>
    小时    
      <input readonly  type="text" size="7" name="a205" id="a205"/>
    分钟</div></td>
  </tr>
  <tr>
    <td colspan="13"><div align="left">居家护理服务&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input readonly  type="text" size="7" name="a206" id="a206"/>
日
<input readonly  type="text" size="7" name="a207" id="a207"/>
小时
<input readonly  type="text" size="7" name="a208" id="a208"/>
分钟</div>      <div align="left"></div>      <div align="left"></div>    <div align="left"></div></td>
  </tr>
  <tr>
    <td colspan="13"><div align="left">三餐（包括上门送餐）
      <input readonly  type="text" size="7" name="a209" id="a209"/>
日
<input readonly  type="text" size="7" name="a210" id="a210"/>
小时
<input readonly  type="text" size="7" name="a211" id="a211"/>
分钟</div>      <div align="left"></div>      <div align="left"></div>    <div align="left"></div></td>
  </tr>
  <tr>
    <td colspan="13"><div align="left">志愿者服务&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input readonly  type="text" size="7" name="a212" id="a212"/>
日
<input readonly  type="text" size="7" name="a213" id="a213"/>
小时
<input readonly  type="text" size="7" name="a214" id="a214"/>
分钟</div>      <div align="left"></div>      <div align="left"></div>    <div align="left"></div></td>
  </tr>
  <tr>
    <td colspan="13"><div align="left">康复理疗服务&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input readonly  type="text" size="7" name="a215" id="a215"/>
日
<input readonly  type="text" size="7" name="a216" id="a216" />
小时
<input readonly  type="text" size="7" name="a217" id="a217"/>
分钟</div>      <div align="left"></div>      <div align="left"></div>    <div align="left"></div></td>
  </tr>
  <tr>
    <td colspan="13"><div align="left">康复功能训练服务&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input readonly  type="text" size="7" name="a218" id="a218"/>
日
<input readonly  type="text" size="7" name="a219" id="a219"/>
小时
<input readonly  type="text" size="7" name="a220" id="a220"/>
分钟</div>      <div align="left"></div>      <div align="left"></div>    <div align="left"></div></td>
  </tr>
  <tr>
    <td colspan="13"><div align="left">康复言语治疗&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input readonly  type="text" size="7" name="a221" id="a221"/>
日
<input readonly  type="text" size="7" name="a222" id="a222"/>
小时
<input readonly  type="text" size="7" name="a223" id="a223"/>
分钟</div>      <div align="left"></div>      <div align="left"></div>    <div align="left"></div></td>
  </tr>
  <tr>
    <td colspan="13"><div align="left">日间照料中心&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input readonly  type="text" size="7" name="a224" id="a224"/>
日
<input readonly  type="text" size="7" name="a225" id="a225"/>
小时
<input readonly  type="text" size="7" name="a226" id="a226"/>
分钟</div>      <div align="left"></div>      <div align="left"></div>    <div align="left"></div></td>
  </tr>
  <tr>
    <td colspan="13"><div align="left">社工上门探访&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <input readonly  type="text" size="7" name="a227" id="a227"/>
日
<input readonly  type="text" size="7" name="a228" id="a228"/>
小时
<input readonly  type="text" size="7" name="a229" id="a229"/>
分钟</div>      <div align="left"></div>      <div align="left"></div>    <div align="left"></div></td>
  </tr>
  <tr>
    ...
    <td colspan="11">30天内是否有计划接受特殊照料、治疗、锻炼计划。包括在家中接受服务项目<br />
      ...
      <input readonly  type="checkbox" class="checkBox1"  name="a230" id="a230"/>
      以下都没有</td>
  </tr>
  <tr>
    <td colspan="11">呼吸系统护理： 
      <select readonly name="a231" id="a231" style="width:50px">
    ...
    吸氧 
    <select readonly name="a232" id="a232" style="width:50px">
     ...
     辅助呼吸器 
     <select readonly name="a233" id="a233" style="width:50px">
  ...
  <tr>
    <td colspan="11">其他护理：
      <select readonly name="a234" id="a234" style="width:50px">
      ...
      酒精/药物治疗
<select readonly name="a235" id="a235" style="width:50px">
...
输血
<select readonly name="a236" id="a236" style="width:50px">
...
化疗
<select readonly name="a237" id="a237" style="width:50px">
...
透析
<select readonly name="a238" id="a238" style="width:50px">
...
输液
<select readonly name="a239" id="a239" style="width:50px">
...
注射（打针）
<select readonly name="a240" id="a240" style="width:50px">
...
造口护理
<select readonly name="a241" id="a241" style="width:50px">
...
放射治疗
<select readonly name="a242" id="a242" style="width:50px">
...
气管造口护理</td>
  ...
  <tr>
    <td colspan="11">治疗：
     <select readonly name="a243" id="a243" style="width:50px">
    ...
    拳操锻炼
   <select readonly name="a244" id="a244" style="width:50px">
    ...
    功能训练
   <select readonly name="a245" id="a245" style="width:50px">
  ...
  <tr>
    <td colspan="11">服务项目：
     <select readonly name="a246" id="a246" style="width:50px">
      ...
      日间服务中心
 <select readonly name="a247" id="a247" style="width:50px">
      ...
      医院
      <select readonly name="a248" id="a248" style="width:50px">
      ...
      临终关怀
 <select readonly name="a249" id="a249" style="width:50px">
      ...
      理疗师或医疗机构上门
      <select readonly name="a250" id="a250" style="width:50px">
  ...
  <tr>
    <td colspan="11">特殊家中照料程序：
       <select readonly name="a251" id="a251" style="width:50px">
      ...
      每日护师/士上门监督指导
      <select readonly name="a252" id="a252" style="width:50px">
...
非每日护师/护士监护      
 <select readonly name="a253" id="a253" style="width:50px">
...
安全报警装置，如腕带安康通等设备
 <select readonly name="a254" id="a254" style="width:50px">
...
皮肤护理
 <select readonly name="a255" id="a255" style="width:50px">
...
特殊饮食护理</td>
  ...
  <tr>
    <td colspan="11"><select readonly name="a256" id="a256" style="width:50px">
    ...
    吸氧 
   <select readonly name="a257" id="a257" style="width:50px">
    ...
    插管
<select readonly name="a258" id="a258" style="width:50px">
...
注射
<select readonly name="a259" id="a259" style="width:50px">
...
造口</td>
  ...
  <tr>
    ...
    <input readonly  type="text" size="7" name="a260" id="a260" /></td>
    <td colspan="4">进医院急诊室（无过夜）的次数
      <input readonly  type="text" size="7" name="a261" id="a261"/></td>
    <td colspan="4">急诊监护（医生、护士、治疗师在医院或家中进行）
    <input readonly  type="text" size="7" name="a262" id="a262"/></td>
  </tr>
  <tr>
    <td><div align="center">治疗预期目标</div></td>
    <td colspan="11">90天内（或上次评估后）目标是否达成 
      <select readonly name="a263" id="a263" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11">与90天前（或上次评估后）相比，个人情况显著变化
      <select readonly name="a264" id="a264" style="width:50px">
  ...
  <tr>
    ...
    <td colspan="11">由于经济情况出现问题，申请者减少购买服务，例如：买药、康复治疗、食物、居家护理服务：
      <select readonly name="a265" id="a265" style="width:50px">
...
0.否 1.是</td>
  ...
  <tr>
    <td colspan="4">评估人员签字：
      <input readonly  type="text" size="17" name="a266" id="a266"/>
评估人员职务：
<input readonly  type="text" size="17" name="a267" id="a267"/>
评估日期（年/月/日）：
<input readonly  type="text" class="Wdate" name="a268" id="a268" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/></td>
  </tr>
  <tr>
...
function initRow(inival,inival1,inival2,inival3){
    ...
    ftd.innerHTML='<div align="center"><input readonly type="text" size="17" name="a269" value='+inival+' ></div>';
    var std = row.insertCell(row.cells.length);
    std.innerHTML='<div align="center"><input readonly type="text" size="17" name="a270" value='+inival1+' ></div>';
    var ttd = row.insertCell(row.cells.length);
    ttd.innerHTML='<div align="center"><input readonly type="text" size="17" name="a271" value='+inival2+' ></div>'
    var ftd = row.insertCell(row.cells.length);
    ftd.innerHTML='<div align="center"><input readonly type="text" class="Wdate" name="a272" onClick="WdatePicker({dateFmt:\'yyyy-MM-dd\',readOnly:true})" value='+inival3+' ></div>'
}
...
function initRow1(inival,inival1,inival2,inival3){
     ...
     ftd.innerHTML=(tbody1.rows.length-2)+'.<input readonly type="text" size="40"  name="a195" value='+inival+' >';
     var std = row.insertCell(row.cells.length);
     std.setAttribute('colSpan',2);
     std.innerHTML='<select readonly name="a196" value='+inival1+' style="width:50px"> '
    ...
    ttd.innerHTML='<input readonly type="text" name="a197" size="7" value='+inival2+' >';
    var ftd = row.insertCell(row.cells.length);
    ftd.setAttribute('colSpan',3);
    ftd.innerHTML='<div align="center"><select readonly name="a198" value='+inival3+' style="width:50px">'
