...
<script type="text/javascript">
	...
	function CreateOneFormPage(){
		...
		LODOP.NEWPAGE();
		//第三页
		LODOP.ADD_PRINT_HTM(38,5,380,1000,document.getElementById("divG1").innerHTML);
		LODOP.ADD_PRINT_HTM(38,390,380,1100,document.getElementById("divG2").innerHTML);
		
		//第四页
		LODOP.NEWPAGE();
		LODOP.ADD_PRINT_HTM(38,5,380,700,document.getElementById("divH").innerHTML);
		LODOP.ADD_PRINT_HTM(718,5,380,500,document.getElementById("divI").innerHTML);
		LODOP.ADD_PRINT_HTM(76,365,350,1000,document.getElementById("divI1").innerHTML);
		
		//第五页
		LODOP.NEWPAGE();
		LODOP.ADD_PRINT_HTM(28,5,380,1050,document.getElementById("divj").innerHTML);
		LODOP.ADD_PRINT_HTM(48,365,380,1050,document.getElementById("divj1").innerHTML);
		
		//第六页
		LODOP.NEWPAGE();
		LODOP.ADD_PRINT_HTM(18,5,380,500,document.getElementById("divk").innerHTML);
		LODOP.ADD_PRINT_HTM(395,5,380,500,document.getElementById("divL").innerHTML);
		LODOP.ADD_PRINT_HTM(595,5,380,500,document.getElementById("divM").innerHTML);
		LODOP.ADD_PRINT_HTM(38,365,380,500,document.getElementById("divM1").innerHTML);
		LODOP.ADD_PRINT_HTM(288,365,380,500,document.getElementById("divN").innerHTML);
		LODOP.ADD_PRINT_HTM(660,365,380,500,document.getElementById("divO").innerHTML);
...
<div class="topLanBar"><b>当前位置：</b>会员管理 > 健康评估表详情</div>
<table width="100%">
  <tr>
...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  width="272"><input disabled type="text" value="${health.memname}" name="memname" id="memname" size="13" readonly/><input disabled type="button" value="选择" onclick="chooseElders();"></td>
  </tr>
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" value="${health.healthnumber}" name="healthnumber" id="healthnumber"/></td>
  </tr>
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" value="${health.assesdate}"  name="assesdate" id="assesdate"/></td>
  </tr>
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><p>评估类型
       <select disabled  id="applyreason" name="applyreason">
...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <select disabled  name="a8" id="a8" style="width:50px">
  ...
  <tr>
    ...
    <select disabled  name="a9" id="a9" style="width:50px">
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">b.比过去90天糟糕： 
     <select disabled  name="a10" id="a10" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
      </select>
    0.否1.是</td>
...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <select disabled  name="a1" id="a1" style="width:50px">
	    <option value="0" selected>0</option>
	    <option value="1">1</option>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <input disabled type="checkbox" class="checkBox1"  name="a2" id="a2" />
    a.短期记忆力-回想5分钟前发生的事</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <input disabled type="checkbox" class="checkBox1"  name="a3" id="a3" />
  ...
  <tr>
    ...
    a.服务老人如何决定一天安排(例如，什么时候起床或吃早饭，穿哪件衣服，参与什么活动)
     <select disabled  name="a4" id="a4" style="width:50px">
	      <option value="0" selected>0</option>
	      <option value="1">1</option>
	      <option value="2">2</option>
	      <option value="3">3</option>
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>是否有必要进行？
       <select disabled  name="a6" id="a6" style="width:50px" onchange="Bian('a7','',this.options.selectedIndex)">
	      <option value="0" selected>0</option>
	      <option value="1">1</option>
      </select>
    </div>
  ...
  <tr>
   ...
   <input disabled type=text id="a7" name="a7" size="5" disabled/></td>
  </tr>
</table>
</div>
<p>&nbsp;</p>
...
<table width="390" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>a.感到悲伤或抑郁，认为或者没有什么值留恋，任何事情都不在乎，认为自己没用还不如死了
      <select disabled  name="a30" id="a30" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
	     <option value="2">2</option>
      </select>
    ...
    <select disabled  name="a16" id="a16" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
	     <option value="2">2</option>
      </select></div>
    <div>e.反复抱怨担忧与焦虑，例如过度紧张日程安排、三餐安排、清洁、服装以及与他人关系
    <select disabled  name="a17" id="a17" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
	     <option value="2">2</option>
      </select>
    ...
    <div>f.脸上表现出担忧、痛苦、难过，例如皱眉
     <select disabled  name="a18" id="a18" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
	     <option value="2">2</option>
      </select>
    ...
    <div>g.经常哭泣
     <select disabled  name="a19" id="a19" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
	     <option value="2">2</option>
      </select>
    ...
    <div>h.丧失兴趣爱好，例如放弃长久以来的兴趣爱好或不与家人朋友交往
     <select disabled  name="a20" id="a20" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
	     <option value="2">2</option>
      </select>
    ...
    <div>i.减少社交活动
     <select disabled  name="a21" id="a21" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
	     <option value="2">2</option>
      </select>
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>比过去90天糟糕:<select disabled  name="a22" id="a22" style="width:50px">
           <option value="0" selected>0</option>
	       <option value="1">1</option>
      </select>0.否 1.是</div>
    </td>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <div>a.没有目的闲逛
       <select disabled  name="a23" id="a23" style="width:50px">
           <option value="0" selected>0</option>
	       <option value="1">1</option>
	       <option value="2">2</option>
    </select>     
    ...
    <div>b.滥用言语，威吓，尖叫，诅咒他人
     <select disabled  name="a24" id="a24" style="width:50px">
           <option value="0" selected>0</option>
	       <option value="1">1</option>
	       <option value="2">2</option>
    </select> 
    ...
    <div>d.社交不当行为，例如重复打断他人声音、噪音、尖叫、自虐行为、公共场所脱衣、乱扔、糟蹋食物/排泄物、乱翻物品等造成干扰的行为
      <select disabled  name="a26" id="a26" style="width:50px">
           <option value="0" selected>0</option>
	       <option value="1">1</option>
	       <option value="2">2</option>
    </select>
    ...
    <div>e.拒绝护理，例如拒绝治疗、服药、生活辅助、吃饭、或更换位置
       <select disabled  name="a27" id="a27" style="width:50px">
           <option value="0" selected>0</option>
	       <option value="1">1</option>
	       <option value="2">2</option>
    </select>
  ...
  <tr>
    ...
    <select disabled   name="a28" id="a28" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
      </select></div>
    <div>0、否 1、是</div></td>
  ...
  <tr>
    ...
    <select disabled   name="a29" id="a29" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
      </select>
    </div>
...
<table width="330" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="266"><div>a.容易与他人相处：
        <select disabled  name="a31" id="a31" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
      </select>
    0.容易 1.不易</div></td>
...
<table width="329" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="73"><input disabled type="text" size="5" name="a369" id="a369"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>d.居家卫生：
      <select disabled  name="a40" id="a40" style="width:50px">
           <option value="0" selected>0</option>
	       <option value="1">1</option>
      </select></div>
      0.无法进行任何居家卫生清洁
...
<table width="375" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="101"><input disabled type="text" size="5" name="a45" id="a45"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" colspan="2">d.着装：
     <select disabled  name="a49" id="a49" style="width:50px">
           <option value="0" selected>0</option>
	       <option value="5">5</option>
	       <option value="10">10</option>
      </select></td>
...
<div align="left" id="divG2" class="fixed_divG2">
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>
      <input disabled type="checkbox" class="checkBox1"  name="a61" id="a61" onclick="enableCheck(64)"/>
      老人相信他/她能够提升自理能力(ADL、IADL、mobility)</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a62" id="a62" onclick="enableCheck(64)"/>
    护理、康复人员相信老人有提升自理能力(ADL、IADL、mobility)</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a63" id="a63" onclick="enableCheck(64)"/>
      现疾病、情况康复状况良好，预期健康状态能改善</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a64" id="a64" onclick="disAb(61,63)"/>
    以上都不是</div></td>
  </tr>
</table>
</div>
...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>(最近7天内排便情况): <select disabled  name="a70" id="a70" style="width:50px">
          <option value="0" selected>0</option>
	      <option value="1">1</option>
	      <option value="2">2</option>
	      <option value="3">3</option>
...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    ...
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a71" id="a71" onclick="enableCheck(74)"/>
      a.脑血管疾病(如中风)</div>
    <div>
    ...
    <div>
      ...
      c.冠心病(心肌梗塞、心绞痛)</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a74" id="a74" onclick="enableCheck(74)"/>
      &nbsp;d.高血压</div>
    <div>
       <input disabled type="checkbox" class="checkBox1"  name="a75" id="a75" onclick="enableCheck(99)"/>
    e.心律不齐</div></td>
  </tr>
</table>
</div>
...
<table width="320" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <input disabled type="checkbox" class="checkBox1"  name="a76" id="a76" onclick="enableCheck(99)"/>
    f.外周动脉疾病</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><p>神经系统</p>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a77" id="a77" onclick="enableCheck(99)"/>
      g.阿兹海默症</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a78" id="a78" onclick="enableCheck(99)"/>
      h.阿兹海默症以外的痴呆症</div>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a79" id="a79" onclick="enableCheck(99)"/>
      i.头部创伤</div>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a80" id="a80" onclick="enableCheck(99)"/>
      j.偏瘫</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a81" id="a81" onclick="enableCheck(99)"/>
      k.多发性硬化症(癫痫)</div>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a82" id="a82" onclick="enableCheck(99)"/>
    l.帕金森氏症</div></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><p>骨骼肌系统</p>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a83" id="a83" onclick="enableCheck(99)"/>
      m.关节炎</div>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a84" id="a84" onclick="enableCheck(99)"/>
      n.髋部骨折</div>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a85" id="a85" onclick="enableCheck(99)"/>
      o.其他骨折(如腕、脊椎)</div>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a86" id="a86" onclick="enableCheck(99)"/>
    p.骨质疏松症</div></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>感觉</div>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a87" id="a87" onclick="enableCheck(99)"/>
      q.白内障</div>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a88" id="a88" onclick="enableCheck(99)"/>
    r.青光眼</div></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><p>精神疾病</p>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a89" id="a89" onclick="enableCheck(99)"/>
    s.任何精神疾病诊断</div></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>感染</div>
    <p>
      <input disabled type="checkbox" class="checkBox1"  name="a90" id="a90" onclick="enableCheck(99)"/>
      t.HIV(艾滋)</p>
    <p>
      <input disabled type="checkbox" class="checkBox1"  name="a91" id="a91" onclick="enableCheck(99)"/>
      u.肺炎</p>
    <p>
      <input disabled type="checkbox" class="checkBox1"  name="a92" id="a92" onclick="enableCheck(99)"/>
      v.肺结核</p>
    <p>
      <input disabled type="checkbox" class="checkBox1"  name="a93" id="a93" onclick="enableCheck(99)"/>
    w.尿路感染(30天内)</p></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>
     <input disabled type="checkbox" class="checkBox1"  name="a94" id="a94" onclick="enableCheck(99)"/>
      x.癌症(近5年内)，不包括皮肤癌</div>
    <p>
      <input disabled type="checkbox" class="checkBox1"  name="a95" id="a95" onclick="enableCheck(99)"/>
      y.糖尿病</p>
    <p>
     <input disabled type="checkbox" class="checkBox1"  name="a96" id="a96" onclick="enableCheck(99)"/>
      z.肺气肿/慢性阻塞性肺病/哮喘结核</p>
    <p>
     <input disabled type="checkbox" class="checkBox1"  name="a97" id="a97" onclick="enableCheck(99)"/>
      aa.肾功能衰竭</p>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a98" id="a98" onclick="enableCheck(99)"/>
    ab.甲状腺疾病</div></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="checkbox" class="checkBox1"  name="a99" id="a99" onclick="disAb(71,98)"/>
    ac.以上都不是</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div align="center">3.</div></td>
...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="226"><div>血型：
       <select disabled  name="a101" id="a101" style="width:50px">
          <option value="0" selected>0</option>
	      <option value="1">1</option>
	      <option value="2">2</option>
	      <option value="3">3</option>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">过敏史：
      <select disabled  name="a102" id="a102" style="width:50px">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
    </select>
      0.无 1.有</td>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">手术史：
      <select disabled  name="a103" id="a103" style="width:50px" onchange="Bian('a109','a110',this.options.selectedIndex)">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
      </select>
      0.无 1.有</td>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>年份：
      <input disabled type="text" name="a104" id="a104"/>
    </div>
    <div>名称：
      <input disabled type="text" size="15" name="a105" id="a105"/>
    </div></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">身高(cm)：
      <input disabled type="text" size="7" name="a106" id="a106"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">体重(kg)：
    <input disabled type="text" size="7" name="a107" id="a107"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">腰围(cm)：
    <input disabled type="text" size="7" name="a108" id="a108"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>空腹血糖：
       <select disabled  name="a109" id="a109" style="width:50px" onchange="Bian('a110','',this.options.selectedIndex)">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
      </select>
    0.未测 1.已测</div>
    <div>
      <input disabled type="text" size="7" name="a110" id="a110"/> 
      (mmol/L)
    </div></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">胸透检查：
      <select disabled  name="a111" id="a111" style="width:50px">
          <option value="0" selected>0</option>
	      <option value="1">1</option>
    </select>
      0.无 1.有</td>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">肝功能检查：
     <select disabled  name="a112" id="a112" style="width:50px">
          <option value="0" selected>0</option>
	      <option value="1">1</option>
      </select>
      0.无 1.有</td>
  ...
  <tr>
    ...
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a113" id="a113" onclick="disAb(114,118)"/>
      无</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a114" id="a114" onclick="enableCheck(113)"/>
      a.腹泻</div>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a115" id="a115" onclick="enableCheck(113)"/>
      b.排尿不畅，或晚间起夜3次以上</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a116" id="a116" onclick="enableCheck(113)"/>
      c.发烧</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a117" id="a117" onclick="enableCheck(113)"/>
      d.食欲下降</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a118" id="a118" onclick="enableCheck(113)"/>
      e.呕吐
    </div></td>
  </tr>
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">近3天内出现的问题：
      <select disabled  name="a119" id="a119" style="width:50px">
          <option value="0" selected>0</option>
	      <option value="1">1</option>
      </select>
    (0.无 1.有)</td>
  ...
  <tr>
    ...
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a120" id="a120"/>
      a.平躺和放松时胸口有压力/疼痛</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a121" id="a121"/>
      b..3天内未排便</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a122" id="a122"/>
      c.晕眩</div>
    <div>
       <input disabled type="checkbox" class="checkBox1"  name="a123" id="a123"/>
      d.食欲下降</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a124" id="a124"/>
      e.水肿</div>
    <div>
       <input disabled type="checkbox" class="checkBox1"  name="a125" id="a125"/>
    f.呼吸急促</div></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>精神健康</div>
    <div>
       <input disabled type="checkbox" class="checkBox1"  name="a126" id="a126"/>
      g.幻觉</div>
    <div>
       <input disabled type="checkbox" class="checkBox1"  name="a127" id="a127"/>
    h.错觉</div></td>
  </tr>
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>a.申请人抱怨疼痛频率:
        <select disabled  name="a128" id="a128">
           <option value="0" selected>0</option>
	      <option value="1">1</option>
        </select>
    </div>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>b.疼痛强度:
      <select disabled  name="a129" id="a129" >
         <option value="0" selected>0</option>
	     <option value="1">1</option>
	     <option value="2">2</option>
	     <option value="3">3</option>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">c.申请人认为疼痛影响日常生活:
      <select disabled  name="a130" id="a130">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
    </select>
      0.不是 1.是的</td>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>d.疼痛患处:
     <select disabled  name="a131" id="a131">
         <option value="0" selected>0</option>
	     <option value="1">1</option>
    </select>
    </div>
...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    ...
    <input disabled type="text" size="7" name="a133" id="a133"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >
    <div><input disabled type="checkbox" class="checkBox1"  name="a135" id="a135" />a.走步不稳</div>
    <div><input disabled type="checkbox" class="checkBox1"  name="a136" id="a136" />b.申请人因害怕摔倒不愿意外出</div></td>
  </tr>
  <tr>
    ...
    <div> <input disabled type="checkbox" class="checkBox1"  name="a137" id="a137" onclick="disAb(138,140)"/>没有</div></td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a138" id="a138" onclick="enableCheck(137)"/>
    a.90天内(或上次评估后)，申请人感到或被人告知要少喝酒，或者他人为老人的饮酒习惯感到担心</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a139" id="a139" onclick="enableCheck(137)"/>
      b.90天内(或上次评估后)，申请人每天一早就开始喝酒或者因为喝酒造成问题</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a140" id="a140" onclick="enableCheck(137)"/>
      c.每天需要吸烟</td>
  </tr>
  <tr>
  ...
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a141" id="a141" onclick="enableCheck(146)"/>
      申请人感到他/她健康很糟糕</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a142" id="a142" onclick="enableCheck(146)"/>
      申请人的疾病或生活条件使得认知功能、脾气或者行为不稳定</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a143" id="a143" onclick="enableCheck(146)"/>
      经历突发性严重疾病或慢性疾病</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a144" id="a144" onclick="enableCheck(146)"/>
      近30天内(或上次评估后)由于突发状况治疗变化</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a145" id="a145" onclick="enableCheck(146)"/>
      诊断活不过6个月-例如医生告知申请者或其家人申请人在病症晚期</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a146" id="a146" onclick="disAb(141,145)"/>
      以上都不是</td>
  </tr>
  <tr>
  ...
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a147" id="a147" onclick="enableCheck(152)"/>
      害怕家人或者护理者</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a148" id="a148" onclick="enableCheck(152)"/>
      个人卫生很糟糕</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a149" id="a149" onclick="enableCheck(152)"/>
      无法解释的创伤、骨折或烧伤</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a150" id="a150" onclick="enableCheck(152)"/>
      被忽视、侵害或虐待</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a151" id="a151" onclick="enableCheck(152)"/>
      肢体受缚(如四肢被绑、坐在椅子上时被绑)</td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a152" id="a152" onclick="disAb(147,151)"/>
      以上都不是</td>
  </tr>
</table>
</div>
...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  width="229"><div>
      <input disabled type="checkbox" class="checkBox1"  name="a153" id="a153"/>
    a.30天内不刻意流失5%体重(180天内体重下降10%)</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a154" id="a154"/>
      b.严重营养不良(极瘦弱)</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a155" id="a155"/>
      c.病态超重
    </div></td>
  </tr>
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a156" id="a156"/>
      a.近2-3天内每天吃1顿或很少</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a157" id="a157"/>
      b.近3天内申请人平时吃的食物或饮水明显减少</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a158" id="a158"/>
      c.水份不足近3天几乎很少补充水份</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a159" id="a159"/>
      d.需用食管进食</td>
  </tr>
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a160" id="a160"/>
    0.正常</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a161" id="a161"/>
    1.需要对大块需要咀嚼的食物进行加工(例如肉块切碎)</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a162" id="a162"/>
    2.需要对大块需要咀嚼的食物以及浓稠液体加工</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a163" id="a163"/>
    3.需要口腔与食管喂食</td>
  </tr>
</table>
</div>
...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="checkbox" class="checkBox1"  name="a164" id="a164"/>
      1.咀嚼困难(例如：下巴不灵活，味觉功能下降、吃饭时候疼痛)</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="checkbox" class="checkBox1"  name="a165" id="a165"/>
      2.吃饭的时候口中干涩</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="checkbox" class="checkBox1"  name="a166" id="a166"/>
      3.刷牙洁牙有困难</td>
  </tr>
</table>
</div>
...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  width="231">任何皮肤问题或皮肤状态变化：
      <select disabled  name="a167" id="a167" style="width:50px">
            <option value="0" selected>0</option>
	        <option value="1">1</option> 
      </select>
    (0.没有变化 1.有变化)</td>
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><div>身体任何地方出现溃疡：
       <select disabled  name="a168" id="a168" style="width:50px">
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a169" id="a169"/>
      a.压疮</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a170" id="a170"/>
      b.郁血性溃疡</td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a171" id="a171" onclick="enableCheck(175)"/>
    烧伤(2级或3级)</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a172" id="a172" onclick="enableCheck(175)"/>
      破裂溃疡、红疹或伤口</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a173" id="a173" onclick="enableCheck(175)"/>
      皮肤出脓</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a174" id="a174" onclick="enableCheck(175)"/>
      术后伤口</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a175" id="a175" onclick="disAb(171,174)"/>
      以上都不是</td>
  </tr>
</table>
</div>
 ...
 <table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  width="231">申请人过去在身体任何部位出现过的溃疡：
      <select disabled  name="a176" id="a176" style="width:50px">
            <option value="0" selected>0</option>
	        <option value="1">1</option>
      </select>
      </td>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a177" id="a177" onclick="enableCheck(181)"/>
    抗生素(全身或局部)</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a178" id="a178" onclick="enableCheck(181)"/>
      外敷</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a179" id="a179" onclick="enableCheck(181)"/>
      术后伤口护理</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a180" id="a180" onclick="enableCheck(181)"/>
      其他疮伤护理(如压力衣、食疗)</td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="checkbox" class="checkBox1"  name="a181" id="a181" onclick="disAb(177,180)"/>
      以上都不是</td>
  </tr>
</table>
</div>
 ...
 <table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  width="232"><div>是否需要提供居家安全评估(上门服务申请者提供)：
      <select disabled  name="a182" id="a182" style="width:50px" onchange="Bian('a183','',this.options.selectedIndex)">
            <option value="0" selected>0</option>
	        <option value="1">1</option> 
      </select>
    </div>
  ...
  <tr>
    ...
    <input disabled type="text" size="7" name="a183" id="a183" ${health.a183 == 0 ? "disabled" : ""} /></td>
  </tr>
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>a.与90天前相比(或上次评估后)申请者现在与他人一同居住(例如，搬去他人家中或别人搬入自己家中)：
       <select disabled  name="a184" id="a184" style="width:50px">
            <option value="0" selected>0</option>
	        <option value="1">1</option> 
      </select>
    </div>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>b.申请者或护理提供方认为申请者最好能够住到另一个环境：
        <select disabled  name="a185" id="a185" style="width:50px">
            <option value="0" selected>0</option>
	        <option value="1">1</option> 
	        <option value="2">2</option> 
	        <option value="3">3</option> 
...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <input disabled type="text" size="7" name="a186" id="a186"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" rowspan="2"><div align="center">2.</div></td>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>7天内服务影响精神的药物：
       <select disabled  name="a187" id="a187" style="width:50px" onchange="BianCheck(188,191,this.options.selectedIndex)">
            <option value="0" selected>0</option>
	        <option value="1">1</option> 
      </select>
    </div>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>
        <input disabled type="checkbox" class="checkBox1"  name="a188" id="a188" onclick="enableselect(187)"/>
    a.抗精神病药物</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a189" id="a189" onclick="enableselect(187)"/>
      b.镇痛药物</div>
    <div>
     <input disabled type="checkbox" class="checkBox1"  name="a190" id="a190" onclick="enableselect(187)"/>
      c.抗抑郁药物</div>
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a191" id="a191" onclick="enableselect(187)"/>
      d.安眠药物
    </div></td>
  </tr>
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div>180天内是否有主治医师对用药进行了解：
      <select disabled  name="a192" id="a192" style="width:50px">
            <option value="0" selected>0</option>
	        <option value="1">1</option> 
      </select>
    </div>
...
<table width="730" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 1px 1px;">
  ...
  <tr>
    ...
    <input disabled type="text" size="25" name="a194" id="a194"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a195" id="a195" style="width:50px" >
             <option value="1" selected>1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
	         <option value="4">4</option> 
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <input disabled type="text" size="20" name="a196" id="a196"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a197" id="a197" style="width:50px">
   ...
   <tr>
    ...
    <input disabled type="text" size="25" name="a198" id="a198"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a199" id="a199" style="width:50px" >
             <option value="1" selected>1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
	         <option value="4">4</option> 
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <input disabled type="text" size="20" name="a200" id="a200"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a201" id="a201" style="width:50px">
     		 <option value="ORN" selected>ORN</option>
	         <option value="OH">OH</option>
	         <option value="O2H">O2H</option>
	         <option value="O3H">O3H</option> 
   ...
   <tr>
    ...
    <input disabled type="text" size="25" name="a202" id="a202"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a203" id="a203" style="width:50px" >
             <option value="1" selected>1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
	         <option value="4">4</option> 
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <input disabled type="text" size="20" name="a204" id="a204"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a205" id="a205" style="width:50px">
     		 <option value="ORN" selected>ORN</option>
	         <option value="OH">OH</option>
	         <option value="O2H">O2H</option>
	         <option value="O3H">O3H</option> 
   ...
   <tr>
    ...
    <input disabled type="text" size="25" name="a206" id="a206"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a207" id="a207" style="width:50px" >
             <option value="1" selected>1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
	         <option value="4">4</option> 
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <input disabled type="text" size="20" name="a208" id="a208"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a209" id="a209" style="width:50px">
     		 <option value="ORN" selected>ORN</option>
	         <option value="OH">OH</option>
	         <option value="O2H">O2H</option>
	         <option value="O3H">O3H</option> 
   ...
   <tr>
    ...
    <input disabled type="text" size="25" name="a210" id="a210"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a211" id="a211" style="width:50px" >
             <option value="1" selected>1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
	         <option value="4">4</option> 
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <input disabled type="text" size="20" name="a212" id="a212"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a213" id="a213" style="width:50px">
     		 <option value="ORN" selected>ORN</option>
	         <option value="OH">OH</option>
	         <option value="O2H">O2H</option>
	         <option value="O3H">O3H</option> 
   ...
   <tr>
    ...
    <input disabled type="text" size="25" name="a214" id="a214"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a215" id="a215" style="width:50px" >
             <option value="1" selected>1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
	         <option value="4">4</option> 
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <input disabled type="text" size="20" name="a216" id="a216"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a217" id="a217" style="width:50px">
     		 <option value="ORN" selected>ORN</option>
	         <option value="OH">OH</option>
	         <option value="O2H">O2H</option>
	         <option value="O3H">O3H</option> 
   ...
   <tr>
    ...
    <input disabled type="text" size="25" name="a218" id="a218"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a219" id="a219" style="width:50px" >
             <option value="1" selected>1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
	         <option value="4">4</option> 
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <input disabled type="text" size="20" name="a220" id="a220"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a221" id="a221" style="width:50px">
     		 <option value="ORN" selected>ORN</option>
	         <option value="OH">OH</option>
	         <option value="O2H">O2H</option>
	         <option value="O3H">O3H</option> 
   ...
   <tr>
    ...
    <input disabled type="text" size="25" name="a222" id="a222"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a223" id="a223" style="width:50px" >
             <option value="1" selected>1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
	         <option value="4">4</option> 
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <input disabled type="text" size="20" name="a224" id="a224"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">
    <select disabled  name="a225" id="a225" style="width:50px">
     		 <option value="ORN" selected>ORN</option>
	         <option value="OH">OH</option>
	         <option value="O2H">O2H</option>
	         <option value="O3H">O3H</option> 
...
<table width="730" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="32"><input disabled type="text" size="3" name="a226" id="a226"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="46"><input disabled type="text" size="3" name="a227" id="a227"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="46"><input disabled type="text" size="3" name="a228" id="a228"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="45"><input disabled type="text" size="3" name="a229" id="a229"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="46"><input disabled type="text" size="3" name="a230" id="a230"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="42"><input disabled type="text" size="3" name="a231" id="a231"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="39"><input disabled type="text" size="3" name="a232" id="a232"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="35"><input disabled type="text" size="3" name="a233" id="a233"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">b.家庭医生\护士上门</td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a234" id="a234"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a235" id="a235"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a236" id="a236"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a237" id="a237"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a238" id="a238"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a239" id="a239"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a240" id="a240"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a241" id="a241"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">c.居家护理服务</td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a242" id="a242"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a243" id="a243"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a244" id="a244"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a245" id="a245"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a246" id="a246"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a247" id="a247"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a248" id="a248"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a249" id="a249"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">d.三餐(包括上门送餐)</td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a250" id="a250"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a251" id="a251"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a252" id="a252"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a253" id="a253"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a254" id="a254"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a255" id="a255"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a256" id="a256"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a257" id="a257"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">e.志愿者服务</td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a258" id="a258"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a259" id="a259"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a260" id="a260"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a261" id="a261"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a262" id="a262"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a263" id="a263"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a264" id="a264"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a265" id="a265"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">f.康复理疗服务</td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a266" id="a266"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a267" id="a267"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a268" id="a268"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a269" id="a269"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a270" id="a270"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a271" id="a271"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a272" id="a272"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a273" id="a273"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">g.康复功能训练服务</td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a274" id="a274"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a275" id="a275"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a276" id="a276"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a277" id="a277"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a278" id="a278"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a279" id="a279"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a280" id="a280"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a281" id="a281"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">h.康复言语治疗</td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a282" id="a282"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a283" id="a283"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a284" id="a284"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a285" id="a285"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a286" id="a286"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a287" id="a287"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a288" id="a288"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a289" id="a289"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">i.日间照料中心</td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a290" id="a290"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a291" id="a291"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a292" id="a292"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a293" id="a293"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a294" id="a294"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a295" id="a295"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a296" id="a296"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a297" id="a297"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">j.社工上门探访</td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a298" id="a298"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a299" id="a299"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a300" id="a300"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a301" id="a301"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a302" id="a302"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a303" id="a303"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a304" id="a304"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><input disabled type="text" size="3" name="a305" id="a305"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" colspan="9"><div>a.吸氧：
      <select disabled  name="a307" id="a307" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     o.理疗： 
        <select disabled  name="a306" id="a306" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      <div>b.辅助呼吸器：
        <select disabled  name="a308" id="a308" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;p.日间服务中心 ：
       <select disabled  name="a309" id="a309" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      <div>c.所有其他呼吸治疗：
       <select disabled  name="a310" id="a310" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp; q.医院：
    <select disabled  name="a311" id="a311" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; r.临终关怀：
    <select disabled  name="a312" id="a312" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;s.理疗师或医疗机构上门：
     <select disabled  name="a313" id="a313" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;t.喘息照料：
     <select disabled  name="a314" id="a314" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" colspan="9"><div>d.酒精/药物治疗
      ：
       <select disabled  name="a315" id="a315" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    u.每日护师/士上门监督指导：
      <select disabled  name="a316" id="a316" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      <div>e.输血
        ：
        <select disabled  name="a317" id="a317" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
   ...
   v.非每日护师/护士监护：
     <select disabled  name="a318" id="a318" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      <div>f.化疗
        ：
        <select disabled  name="a319" id="a319" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      &nbsp;w.安全报警装置，如腕带安康通等设备：
 <select disabled  name="a320" id="a320" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      <div>g.透析
        ：
        <select disabled  name="a321" id="a321" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      x.皮肤护理：
     <select disabled  name="a322" id="a322" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      <div>h.输液
        ：
         <select disabled  name="a323" id="a323" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      <div>i.注射(打针)：
         <select disabled  name="a324" id="a324" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      <div>j.造口护理
        ：
        <select disabled  name="a325" id="a325" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      <div>k.放射治疗
        ：
         <select disabled  name="a326" id="a326" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
      ...
      <div>l.气管造口护理：
        <select disabled  name="a327" id="a327" style="width:50px">
         	 <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
...
<table width="730" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <div>m.拳操锻炼：  <select disabled  name="a328" id="a328" style="width:50px">
             <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
    </select> </div>
    <div>n.功能训练：  <select disabled  name="a329" id="a329" style="width:50px">
             <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  width="283"><div>y.特殊饮食护理：
     <select disabled  name="a330" id="a330" style="width:50px">
             <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
    ...
    <div>
      <input disabled type="checkbox" class="checkBox1"  name="a331" id="a331"/>
    aa.以上都不是</div></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  rowspan="3"><div align="center">3.</div></td>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">a.吸氧：
     <select disabled  name="a332" id="a332" style="width:50px">
             <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">c.插管：
       <select disabled  name="a333" id="a333" style="width:50px">
             <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">b.注射：
       <select disabled  name="a334" id="a334" style="width:50px">
             <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;">d.造口：
      <select disabled  name="a335" id="a335" style="width:50px">
             <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
	         <option value="3">3</option>
  ...
  <tr>
    ...
    <div>a.在医院过夜次数
      <input disabled type="text" size="6" name="a336" id="a336"/>
    </div>
    <div>b.进医院急诊室(无过夜)的次数
      <input disabled type="text" size="6" name="a337" id="a337"/>
    </div>
    <div>c.急诊监护(医生、护士、治疗师在医院或家中进行)  
      <input disabled type="text" size="6" name="a338" id="a338"/>
    </div></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div align="center">5.</div></td>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  colspan="2"><div>90天内(或上次评估后)目标是否达成：
      <select disabled  name="a339" id="a339" style="width:50px">
             <option value="0" selected>0</option>
	         <option value="1">1</option>
       </select> 
    </div>
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  colspan="2"><div>与90天前(或上次评估后)相比，个人情况显著变化：
     <select disabled  name="a340" id="a340" style="width:50px">
             <option value="0" selected>0</option>
	         <option value="1">1</option>
	         <option value="2">2</option>
       </select> 
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  colspan="2">由于经济情况出现问题，申请者减少购买服务，例如：买药、康复治疗、食物、居家护理服务：
       <select disabled  name="a341" id="a341" style="width:50px">
             <option value="0" selected>0</option>
	         <option value="1">1</option>
       </select> 
      0.否 1.是</td>
...
<table width="730" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    ...
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" colspan="3"><input disabled type="text" size="20" name="a342" id="a342"/></td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >b.评估人员职务</td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" colspan="3"><input disabled type="text" size="20" name="a343" id="a343"/></td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >c.评估日期(年/月/日)</td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" colspan="3"><input disabled type="text" size="20" name="a344" id="a344" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >e.<input disabled type="text" size="20" name="a345" id="a345"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a346" id="a346"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a347" id="a347"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a348" id="a348" /></td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >f.<input disabled type="text" size="20" name="a349" id="a349"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a350" id="a350"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a351" id="a351"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a352" id="a352" /></td>
  </tr>
  <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >g.<input disabled type="text" size="20" name="a353" id="a353"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a354" id="a354"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a355" id="a355"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a356" id="a356" /></td>
  </tr>
   <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >h.<input disabled type="text" size="20" name="a357" id="a357"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a358" id="a358"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a359" id="a359"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a360" id="a360" /></td>
  </tr>
   <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >i.<input disabled type="text" size="20" name="a361" id="a361"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a362" id="a362"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a363" id="a363"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a364" id="a364" /></td>
  </tr>
   <tr>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >j.<input disabled type="text" size="20" name="a365" id="a365"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a366" id="a366"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a367" id="a367"/></td>
    <td  style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input disabled type="text" size="20" name="a368" id="a368" /></td>
  </tr>
