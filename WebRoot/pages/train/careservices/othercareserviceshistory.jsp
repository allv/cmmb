...
function batView(onumber){
   window.location.href=basePath+"/othercareservicesviewacthistory.do?onumber="+onumber;
}
...
<body>
<div class="topLanBar"><b>当前位置：</b>护理管理> 介护服务> 其他介护服务历史记录</div>
<table width="100%">
  <tr>
...
<form method="post" name="actform" action="othercareserviceshistory.do">
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableList">
    ...
    <tr>
	      ...
	      <td align="center" nowrap bgcolor="#E4E4E4"><a href="javascript:batView('${car.onumber}');">明细</a>&nbsp;&nbsp;</td>
    </tr>
    </c:forEach>
    <wt:pages />
    </c:otherwise>
