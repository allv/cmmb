...
public class healthpsyeval implements java.io.Serializable
{
    //表主鍵
    private String mmseid;
    //健康评估表外键
    ...
    // Constructors
    /** default constructor */
    public healthpsyeval()
    {
    }
    // Property accessors
	public String getMmseid() {
		return mmseid;
	}
	...
	public String getAssesdep() {
		return assesdep;
	}

	public void setAssesdep(String assesdep) {
		this.assesdep = assesdep;
	}

	public void setMmseid(String mmseid) {
		this.mmseid = mmseid;
	}
