...
function helView(hdate){
   window.location.href=basePath+"/helpcleanviewacthistory.do?hdate="+hdate;
}
...
<body>
<div class="topLanBar"><b>当前位置：</b>护理管理> 介护服务> 助洁服务历史记录</div>
<table width="100%">
  <tr>
...
<form method="post" name="actform" action="helpcleanhistory.do">
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableList">
    ...
    <tr>
	      ...
	      <td align="center" nowrap bgcolor="#E4E4E4"><a href="javascript:helView('${hel.hdate}');">明细</a>&nbsp;&nbsp;</td>
    </tr>
    </c:forEach>
    <wt:pages />
    </c:otherwise>
