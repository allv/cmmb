...
function memhealthforpsyedit(healthinfoid){
   window.location.href=basePath+"/healthEvalpremodifypsy.do?healthid="+healthinfoid;
}
</script>
</head>
<body>
...
<form method="post" action="healthEvallistH.do">
  <table width="100%" border="0" cellspacing="0" cellpadding="2">
    <tr>
      ...
      <td><input type="text" id="applyreason" size="18" name="applyreason" value="" />
      </td>
    </tr>
    <tr>
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableList">
    ...
    <tr>
	      ...
	      <td align="center" nowrap bgcolor="#E4E4E4">${healtheval.applyreason}</td>
	      ...
	      <c:if test="${healtheval.a6=='1'}">
		      <a href="javascript:memhealthforpsyedit('${healtheval.healthid}');">心理评估表</a>&nbsp;&nbsp;
		  </c:if>
	      </td>
    </tr>
    </c:forEach>
