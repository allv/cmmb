...
function batView(cdate){
   window.location.href=basePath+"/bathrecordviewacthistory.do?cdate="+cdate;
}
...
<body>
<div class="topLanBar"><b>当前位置：</b>护理管理> 介护服务> 助浴服务历史记录</div>
<table width="100%">
  <tr>
...
<form method="post" name="actform" action="bathrecordhistory.do">
  <table width="100%" border="0" cellspacing="0" cellpadding="2">
    ...
    <tr>
      ...
      <td><input name="cname" id="cname" value="" type="text" size="20">
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableList">
    ...
    <tr>
	      ...
	      <td align="center" nowrap bgcolor="#E4E4E4">${recl.cpeople} </td>
	      <td align="center" nowrap bgcolor="#E4E4E4">${recl.cstarttime} </td>
	      <td align="center" nowrap bgcolor="#E4E4E4"><a href="javascript:batView('${recl.cdate}');">明细</a>&nbsp;&nbsp;</td>
    </tr>
    </c:forEach>
    <wt:pages />
    </c:otherwise>
