...
<body onload="shows()">
<div class="topLanBar"><b>当前位置：</b>护理管理 >介护服务 > 修改老年人介护服务记录</div>
<table width="100%">
  <tr>
...
<div>
老人姓名:<input name="sname" type="text" value="" class="txt" onclick="chooseElders()" readonly/>
性别:<input name="sgender" type="text" value="" class="txt" readonly/>
年龄:<input name="sage" type="text" value="" class="txt" readonly/>
...
<table  width="100%" border="0" cellpadding="3" cellspacing="1" class="tableList">
    ...
    <tr>
     ...
     <td align="center" nowrap bgcolor="#E4E4E4"><input type="checkbox" class="checkBox1"  name="b_id" /></td>
     <td align="center" nowrap bgcolor="#E4E4E4"><input type="checkbox" class="checkBox1"  name="b_id" /></td>
     <td align="center" nowrap bgcolor="#E4E4E4"><input name="sother" type="text" value="" size="22"/></td>
     <td align="center" nowrap bgcolor="#E4E4E4"><input name="speople" type="text" value="" size="22"/></td>
     <td align="center" nowrap bgcolor="#E4E4E4" rowspan="5"><textarea name="status" cols="50" rows="9"></textarea></td>
    </tr>
    <tr>
