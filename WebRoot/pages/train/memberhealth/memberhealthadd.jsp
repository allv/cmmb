...
<table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  width="272"><input type="text" name="memname" id="memname" size="13" readonly/><input type="button" value="选择" onclick="chooseElders();"></td>
  </tr>
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input type="text" name="healthnumber" id="healthnumber"/></td>
  </tr>
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input type="text"  name="assesdate" id="assesdate" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/></td>
  </tr>
  <tr>
...
<table width="329" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="73"><input type="text" value="0" name="a369" id="a369" size="5" readonly/></td>
  </tr>
  <tr>
...
<table width="375" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="101"><input type="text" value="0" size="5" name="a45" id="a45" readonly/></td>
  </tr>
  <tr>
...
<div>N.环境评估</div>
 <table width="350" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    ...
    <input type="text" size="7" name="a183" id="a183" disabled /></td>
  </tr>
  <tr>
...
function Bian(targetCom1,targetCom2,selectindex){
        if(selectindex==0){
           ...
           /*
           var but = window.confirm("现在开始做心理评估吗？");
           if(but){
        	  var url =  basePath+"/healthEvalpremodifypsy.do?healthid="+healthinfoid;
        	  str = window.showModalDialog(url,obj,"dialogWidth=1000px;dialogHeight=800px"); 
           }*/
        }
}
