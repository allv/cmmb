...
public class proQueryAction extends BaseAction
{
            ...
            HttpServletResponse response) 
    {
        ...
        PsychologyService psychologyservice = IMPServiceFactory.getPsychologyService();
        try {
			result = psychologyservice.getQueryProResult(firstindex, maxresult,
					prostartdate, proenddate, proname, proidentity,
