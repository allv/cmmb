...
<script type="text/javascript">
    ...
    function Save() {
        ...
        $.ajax({
					type : "POST",
					url : basePath + "/activitysaveHouse.do?ahnum=" + 
					ahnum+"&ahmanager="+ahmanager+"&ahvolunteer="+ahvolunteer+"&ahplan="+ahplan+"&arrange1="+arrange1
...
<body>
<div class="topLanBar"><b>当前位置：</b>活动室管理 >活动室管理 > 新增活动室</div>
<table width="100%">
  <tr>
    <td background="<%=basePath%>/pages/train/skins/img/lan-index.gif">&nbsp;</td>
  </tr>
</table>
<form name="myform"  method="post" action="activitysaveHouse.do">
<table  width="100%" border="0" cellpadding="3" cellspacing="1">
     <tr>
      <td align="right">活动室编号</td>
      <td><input type="text" name="ahnum" id="ahnum" /><span style='color:red;'>&nbsp;*</span></td>
    </tr>
    <tr>
      <td align="right">管理员</td>
      <td><input type="text" name="ahmanager" id="ahmanager"/><span style='color:red;'>&nbsp;*</span></td>
    </tr>
    
    <tr>
      <td align="right">志愿者</td>
      <td><textarea name="ahvolunteer" id="ahvolunteer" cols="58" rows="4"></textarea></td>
    </tr>
    
    <tr>
      <td align="right">备注</td>
      <td><textarea name="ahplan" id="ahplan" cols="58" rows="4"></textarea></td>
    </tr>
</table>
...
<table width="730" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" width="545"><textarea name="arrange1" id="arrange1" rows="4" cols="60"></textarea></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div align="center">周二</div></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><textarea  name="arrange2" id="arrange2" rows="4" cols="60"></textarea></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div align="center">周三</div></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><textarea name="arrange3" id="arrange3" rows="4" cols="60"></textarea></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div align="center">周四</div></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><textarea name="arrange4" id="arrange4" rows="4" cols="60"></textarea></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><div align="center">周五</div></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"><textarea name="arrange5" id="arrange5" rows="4" cols="60"></textarea></td>
  </tr>
</table>
