...
public class UploadFileServlet extends HttpServlet
{
    ...
    //-------wj------------------
    private static String fileExt = "jpg,jpeg,gif,png,swf,wmv,avi,wma,mp3,mid";//上传扩展名
    ...
    private static String dirType = "3";
    ...
    public void init() throws ServletException
    {
        ...
        if (StringUtils.isBlank(fileExt))
            fileExt = "jpg,jpeg,gif,png,swf,wmv,avi,wma,mp3,mid";
            ...
            throws ServletException, IOException
    {
        ...
        try
        {
            ...
            String extensionName = fileNameLong
                    .substring(fileNameLong.lastIndexOf(".") + 1);
