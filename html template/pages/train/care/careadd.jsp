      ...
      for(i=1;i<=84;i++){
         if(document.getElementById("a"+i).type=='checkbox'){
            ...
            paraurl = paraurl+'&'+('a'+i)+'='+encodeURI(b);
	            ...
	            $.ajax({
				   type: "POST",
				   url: basePath + "/careaddcare.do?memnumber="+encodeURI(memnumber)+"&memname="+encodeURI(memname)+"&assesman="+encodeURI(assesman)+"&assesdate="+assesdate+"&carenumber="+encodeURI(carenumber)+"&belongproname="+encodeURI(belongproname)+paraurl,
...
<body>
<div class="topLanBar"><b>当前位置：</b>护理管理 > 护理表增加</div>
<table width="100%" >
  <tr>
...
<table width="840" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  width="187"><input name="memname" id="memname" type="text" size="13"/><input type="button" value="选择" onclick="chooseElders();"></td>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  width="230" rowspan="2"><input id="belongproname" name="belongproname" type="text" /></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >档案编号 <span style='color:red;'>&nbsp;*</span></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input name="carenumber" id="carenumber" type="text" /></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >会员编号(如有)</td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input type="text" name="memnumber" id="memnumber"/></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  rowspan="2"><div align="center">家庭地址</div></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  rowspan="2"><input type="text" name="a1" id="a1"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >评估人员签字<span style='color:red;'>&nbsp;*</span></td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input type="text" name="assesman" id="assesman"/></td>
  </tr>
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" >评估人员职务</td>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input type="text" name="a2" id="a2"/></td>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><input type="text" class="Wdate" name="assesdate" id="assesdate" value="${care.assesdate}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
      (年/月/日)</td>
  </tr>
</table>
<p>&nbsp;</p>
<span align="left" id="Apos">A. 健康情况(根据G2.健康评估表 I.疾病诊断)</span>
<table width="840" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" colspan="4"><p>备注：(对以上未列入疾病进行描述或对某项疾病进行详细补充)</p>
    <div>
      <textarea name="textarea" id="a20" cols="120" rows="7"></textarea>
    </div></td>
  </tr>
</table>
<br/>
...
<table width="410" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  width="153"><input type="text" id="a21" name="a21"/></td>
  </tr>
  <tr>
...
<table width="419" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  <tr>
...
<table width="408" height="490" border="1" style="table-layout:auto;border:solid #8B8378; border-width:1px 0px 0px 1px;">
  ...
  <tr>
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;"  height="52"><p>
      ...
      护士上门指导 <input type="checkbox" class="checkBox1" name="a84" id="a84" />
      陪伴就医</p>
      <p>
  ...
  <tr>
    ...
    <td style="border:solid #8B8378; border-width:0px 1px 1px 0px; padding:0px 0px;" ><div align="left">
      <textarea name="textarea2" name="a83" id="a83"  cols="45" rows="6"></textarea>
    </div></td>
  </tr>
</table>
<p>&nbsp;</p>
