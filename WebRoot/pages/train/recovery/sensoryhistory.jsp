...
function psyView(snumber){
   window.location.href=basePath+"/sensoryviewacthistory.do?snumber="+snumber;
}
...
<body>
<div class="topLanBar"><b>当前位置：</b>康复管理> 康复服务> 感官功能康复历史记录</div>
<table width="100%">
  <tr>
...
<form method="post" name="senform" action="sensoryhistory.do">
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" class="tableList">
    ...
    <tr>
	      ...
	      <td align="center" nowrap bgcolor="#E4E4E4"><a href="javascript:psyView('${sen.snumber}');">明细</a>&nbsp;&nbsp;</td>
    </tr>
    </c:forEach>
    <wt:pages />
    </c:otherwise>
