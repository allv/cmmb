...
/**
 * recoveryAssess entity. @author MyEclipse Persistence Tools
 */

public class recoveryAssess implements java.io.Serializable
{
    //康复评估主鍵
    ...
    //医师签名
    private String assesman;
    //康复评估日期
    private String assesdate;
    //评估所属项目id
    private String belongproid;
    //评估所属项目名称
    private String belongproname;
   
    //意识 1:清晰 2:嗜睡 3:昏迷 0:未填
    private String a1;
    //关节活动度 0:未填 1:正常 2:异常 3:肩关节 4:肘关节 5:腕关节 6:髋关节 7:膝关节 8:踝关节
    private String a2;
    //肌肉力量 0:未选 1:正常 2：减弱 3：肱二头肌 4：肱三头肌 5：前臂伸腕肌群 6：前臂屈腕肌群 7：髂腰肌 8：股四头肌 9：股二头肌 10：小腿三头肌 11：胫前肌
    private String a3;
    //感觉功能 0:未选 1：正常 2：异常
    private String a4;
    //感觉功能 异常备注
    private String a5;
    //平衡功能 0:未选 坐位平衡 1:不能完成 2:能完成（3:I   4:II   5:III  ）
    //站位平衡 6:不能完成 7:能完成（8:I   9:II   10:III  ）
    private String a6;
    //转移能力 0:未选 1:床椅,轮椅 2:入厕 3:浴缸、沐浴 4:卧床
    private String a7;
    //步态检查 0:未选 1：卧床 2：正常步态 3：异常步态
    private String a8;
    //认知能力 0:未选 记忆力：1：正常 2：异常 注意力：3：正常 4：异常
    private String a9;
    //辅助工具 0:未选 1:不需要  2:需要（3:手杖 4:辅助器 5:假肢 6:轮椅 7:拐杖 8:矫形器 9:平车）
    private String a10;
    //疼痛  0:未选  1:部位 2:无疼痛
    private String a11;
    //疼痛 部位 
    ...
    //疼痛 VAS评分
    private String a13;
    //肢体肿胀 0:未选  1:部位 2:无肿胀
    private String a14;
    //二便管理 0:未选 小便：1:留置导尿 2:正常 3:失禁    大便：4:正常  5:便秘  6:失禁
    private String a15;
    //肢体肿胀 部位
    private String a16;
    //压疮 0:未选 1:无 2：有
    ...
    //言语功能 0:未选 1:正常  2:异常
    private String a20;
    //独立生活能力  0:未选 1:独立生活I 2:小部分帮助S  3:大部分帮助A   4:完全依赖D
    private String a21;
    //特殊评估 0:未选 1:偏瘫 Brunnstrom 截瘫：ASIA评估  （2:完全损伤 3:不完全损伤） 痉挛  4:上肢 5:下肢 
    private String a22;
    //特殊评估 评估（手：   级； ）
    private String a23;
    //特殊评估 评估 上肢：   级； 
    ...
    // Constructors
    /** default constructor */
    public recoveryAssess()
    {
    }

    /** minimal constructor */
    public recoveryAssess(String recoveryid, String recoverynumber, String memgender,String memage,
            ...
            ,String a75,String a76,String a77,String a78,String a79,String a80,String a81)
    {
	...
	public String getAssesman() {
		return assesman;
	}

	public void setAssesman(String assesman) {
		this.assesman = assesman;
	}
